    ...
    <section>
        <div class="pageintro">
            ...
            <div class="pageintro-body">
                <h1 class="pageintro-title">Giỏ hàng của bạn</h1>
            </div>
        </div>
    </section>
    <!-- End Page Title -->
                            ...
                            <table class="table-shop">
                                ...
                                while ($rows = mysqli_fetch_array($query)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo number_format($rows['selling_price'], 0, ',', '.') . " VNĐ" ?>
                                        </td>
                                        <td>
                                            <div class="quantity">
                                        <span class="sub">
                                ...
                                <tr>
                                    <td colspan="5">
                                        <div class="table-shop-product">
                                            <div class="name" style="margin: auto;color: orangered">Tổng tiền
                                                : <?php echo number_format($totalprice, 0, ',', '.') . " VNĐ"; ?></div>
                                        </div>
                                    </td>
                                </tr>
                                </tbody>
                                ...
                                <tr>
                                    <td colspan="5">
                                        <div class="table-button">
                                            ...
                                            <button type="submit" name="submit" style="cursor: pointer">Cập nhật lại giỏ
                                                hàng
                                            </button>
