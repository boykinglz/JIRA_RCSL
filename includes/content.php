            ...
            <div class="grid">
                <div class="grid-filter">
                    <ul class="text-center">
                        ...
                        echo '<li><span data-filter=\'*\'>Tất cả sản phẩm</span></li>';
                        ?>
                    </ul>
                </div>
                    ...
                    for ($i = 0;$i<count($data);$i++){
                        ...
                        if ($a == 0){
                            ...
                            <div class=\"grid-product\">
                                <p style='width: 300px;'>Hiện danh mục này chưa có sản phẩm!</p>
                            </div>
                        </div>
                        ";
                        }
                        while ($rows = mysqli_fetch_array($r,MYSQLI_ASSOC)){
                            ...
                            <div class=\"grid-product\">
                               ...
                               echo " </a>
                                    <div class=\"addcart\">
                                        <a href=\"cart.php?action=add&id={$rows['product_id']}\">Thêm vào giỏ hàng</a>
                                    </div>
                                </div>
                                <a href='product_detail.php?pid={$rows['product_id']}' class=\"name\">{$rows['product_name']}</a>
                                <div class=\"price\">".number_format($rows['selling_price'], 0, ',', '.')." VNĐ</div>
                            </div>
                        </div>
                        ";
                        }
